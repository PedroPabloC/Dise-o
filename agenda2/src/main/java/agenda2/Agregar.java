...
public class Agregar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, 70, -1));
...
// TODO add your handling code here:
        ...
        if(nombre.getText().length()==0 || numeroFono.getText().length()==0){
            ...
            if(generoElegido.equals("Masculino")){
                genero = Genero.Masculino;
            }else{
                genero = Genero.Femenino;
            }
            
            if(tipoFono.getSelectedItem().toString().equals("Fijo")){
                tf = TipoFono.Fijo;
            }else{
                tf = TipoFono.Celular;
            }
            Contacto newContacto = new Contacto(nombre.getText(), apellido.getText(), genero, tf, numeroFono.getText(), correo.getText() );
            MiAgenda.agregarContacto(newContacto);
